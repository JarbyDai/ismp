...
<div class="trnmenu"> <span class="left trnmenutlt">代收付：</span>
  <div class="rtnms">
    <ul>
        ...
        <li class="rtncnt blue">新增证书</li>
    </ul>
  </div>
</div>
<g:form method="post" controller="agentpay" action="certupload" enctype="multipart/form-data" style="width:960px; margin:0 auto">
    <div class="serchlitst">
        ...
        <table class="tlb1">
          <tr>
            <td width="20%" class="txtRight" scope="col">证书类型：</td>
            <td width="40%" class="txtLeft"  scope="col">
                <g:select name="type" value="${params.type}" from="${serviceMap}" optionKey="key" optionValue="value" noSelection="${['':'-请选择证书类型-']}" />
            </td>
