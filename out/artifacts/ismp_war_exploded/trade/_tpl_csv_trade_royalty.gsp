...
#----------------------------------------分润明细列表结束-------------------------------------
#支出合计：${out_count?out_count:0}笔，共-<g:formatNumber number="${(out_amount?out_amount:0)/100}" format="#.00#"/>元
#收入合计：${in_count?in_count:0}笔，共<g:formatNumber number="${(in_amount?in_amount:0)/100}" format="#.00#"/>元
