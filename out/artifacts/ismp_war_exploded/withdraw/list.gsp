    ...
    <div class="serchlitst">
        ...
        <table class="tlb1">
          <tr>
            ...
            <th class="txtCenter" scope="col">提现时间</th>
            <th class="txtCenter" scope="col">提现金额（元）</th>
            <th class="txtCenter" scope="col">提现银行</th>
                ...
                <tr>
                    <td scope="col" class="txtCenter">
                        <g:if test="${session.level3Map != null && session.level3Map['trade/detail'] != null}">
                            <a href="${createLink(controller: 'trade', action: 'detail')}/${trade.id}" style="color:blue">${trade.tradeNo}</a>
                        </g:if>
                    </td>
                    ...
                    <td scope="col" class="txtCenter">${boss.BoBankDic.findByCode(trade?.customerBankCode)?.name}</td>
                    <td scope="col" class="txtCenter">${trade?.customerBankAccountNo}   </td>
