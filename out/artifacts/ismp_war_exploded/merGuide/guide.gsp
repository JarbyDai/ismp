...
<body>
    <div class="guide-container">
        ...
        <section class="guide-tit">
            <span>商户申请指引</span>
            <span>|</span>
            <span class="tips-span">普通在线商户</span>
        </section>
        <!-- 商户类型 -->
        <section class="guide-mode">
            <ul>
                <li class="general-business link-box">
                    <a href="${createLink(controller: 'merGuide',action: 'guide')}" class="guide-link general-link" id="pt-link">
        ...
        <div class="patten-container" id="pt-business">
            <!-- 普通在线商户 -->
            <section class="general-container section_box" id="general">
                <!-- 商户资料 -->
                <section class="business-material">
                    <header class="material-tit">
                        <h2>申请<span><a href="" class="color-red">普通在线商户开服</a></span>需要准备哪些资料？</h2>
                    </header>
