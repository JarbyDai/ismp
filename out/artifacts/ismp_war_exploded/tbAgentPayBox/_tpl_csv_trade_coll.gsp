...
<g:each in="${tradeList}" status="i" var="trade">${trade.id.toString()}		,${trade.batchDate}	,${trade.batchTypeMap[trade.batchType]},${trade.batchFilename}		,${trade.batchCount},<g:formatNumber number="${trade.batchAmount.toString()}" format="#0.00#"/>		,${trade.statusMap[trade.batchStatus]},${trade.batchRemark1}
</g:each>
#-------------------------------------------------------------------------------------------
