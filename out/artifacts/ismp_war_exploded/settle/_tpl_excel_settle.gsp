...
4400;width:130pt'>
 ...
 <tr height=18 style='height:13.5pt'>
  <td height=18 class=xl637821 width=202 style='height:13.5pt;width:151pt'>合利宝结算查询<span style='mso-spacerun:yes'>&nbsp;</span></td>
  <td class=xl637821 width=80 style='width:60pt'>结算类型：${BoCustomerService.serviceMap[params.serviceType]}</td>
  ...
  <td class=xl637821 colspan=3 width=169 style='width:137pt'>起始日期：[${params.startDate}]   终止日期: [${params.endDate}]</td>
...
<g:each in="${acSeqList}" status="i" var="acSeq">
 <tr height=18 style='height:13.5pt'>
  <td  class=xl677821 style='border-left:none'>${acSeq.dateCreated.format("yyyy-MM-dd HH:mm:ss")}</td>
  <td class=xl677821 style='border-left:none'>${acSeq.transaction.tradeNo}</td>
  <td class=xl657821  align=right style='border-left:none'>${acSeq.transaction.transTypeMap[acSeq.transaction.transferType]}</td>
  <td class=xl657821  align=right style='border-left:none'> +<g:formatNumber number="${acSeq.debitAmount/100}" format="#0.00#"/></td>
  <td class=xl657821  align=right style='border-left:none'>-<g:formatNumber number="${acSeq.creditAmount/100}" format="#0.00#"/></td>
  <td class=xl657821  align=right style='border-left:none'><g:formatNumber number="${acSeq.balance/100}" format="#0.00#"/></td>
  <td class=xl657821  align=right style='border-left:none'> ${acSeq.transaction.subjict=='null'?'':acSeq.transaction.subjict}</td>
 </tr>
 </g:each>
