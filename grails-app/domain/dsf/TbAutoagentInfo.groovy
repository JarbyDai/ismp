...
class  TbAutoagentInfo {
    ...
    String batchStatus //状态 0 处理中  1 交易失败  2 暂时成功  3 交易成功
    ...
    public void addDetail(TbAutoagentDetailsInfo detail){
        this.addToTbAutoagentDetailsInfos(detail);
    }
    static hasMany = [tbAutoagentDetailsInfos : TbAutoagentDetailsInfo ]

    def static batchTypeMap = ['S':'代收','F': '代付']
    def static  feeTypeMap = ['0':'即扣','1':'后返']
    //def static statusMap = ['0':'待确认','1':'待审核','2':'商户审核拒绝','3':'处理中','4':'交易完毕']
    def static statusMap = ['0':'处理中','1':'交易失败','2':'暂时成功','3':'交易成功']
