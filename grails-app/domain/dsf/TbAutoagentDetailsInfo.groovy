 ...
 */
class TbAutoagentDetailsInfo {
    static mapping = {
        version false
        id generator: 'assigned', column:'DETAIL_ID'
        tablePerHierarchy false
        batch lazy:false   //也可以这样去配置
    }
    ...
    String tradeStatus       //交易状态:['0':'处理中','1':'交易失败','2':'暂时成功','3':'交易成功']     //作废
    //交易状态:['2':'待处理','3':'商户拒绝','6':'处理中','7':'处理完毕']
    Double tradeFee          //手续费
    Date tradeSysdate          //不再使用
    ...
    dsf.TbAutoagentInfo batch
    static belongsTo = dsf.TbAutoagentInfo

    String tradeProvince  //开户所在省
    String tradeCity      //开户所在市
    String errMsg         //错误信息
    String tradeCommtype  //商户审核方式 1 手工 : 0 自动
    String tradeSystype   //业管审核方式 1 手工 : 0 自动
  ...
  //  String contractId //席位号
    ...
    static constraints = {
        ...
        tradeAccounttype(nullable:true)
        ...
        certificateNum(nullable:true)
        tradeMobile(size:1..13,nullable:true)
        tradeRemark(nullable:true)
        tradeFeedbackcode(size:1..10,nullable:true)
        tradeReason(size:1..500,nullable:true)
        tradeRemark1(nullable:true)
        tradeRemark2(nullable:true)
        tradeRemark3(nullable:true)
        tradeRemark4(nullable:true)
        tradeRemark5(nullable:true)
    ...
    //def static tradeStatusMap = ['0':'待确认','1':'待审核','2':'待处理','3':'商户拒绝','4':'合利宝拒绝','5':'合利宝审核通过','6':'处理中','7':'处理完毕']
    def static tradeStatusMap = ['2':'待处理','3':'交易失败','6':'处理中','7':'处理完毕']    //['0':'处理中','1':'交易失败','2':'暂时成功','3':'交易成功']
    ...
    def static tradeTypeMap = ['S':'代收','F': '代付']
    ...
    def static tradeRefuedMap = ['0':'待退款','1':'退款已初审','2':'已退款']
}
