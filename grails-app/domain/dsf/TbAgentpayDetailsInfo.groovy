...
class TbAgentpayDetailsInfo {
    static mapping = {
        ...
        tablePerHierarchy false
               ...
               String tradeStatus       //交易状态:['0':'待确认','1':'待审核','2':'待处理','3':'商户拒绝','4':'合利宝拒绝','5':'合利宝审核通过','6':'处理中','7':'处理完毕']
               Double tradeFee          //手续费
               ...
               String errMsg         //错误信息
               String tradeCommtype  //商户审核方式 0 自动 : 1 手工
               String tradeSystype   //业管审核方式 0 自动 : 1 手工
