...
class TradeBase {
    ...
    static constraints = {
        ...
        status(maxSize: 16,inList: ['starting','processing','completed','closed','fail','cancel'])
    ...
    def static statusMap = ['starting': '开始', 'processing': '处理中','completed':'完成','fail':'失败', 'closed' : '关闭', 'cancel' : '取消']
    def static paymentTypeMap=['1': 'B2C网银','2': 'B2B网银','3':'预付费卡','4':'合利宝账户','5':'快捷支付','6':'现金','7':'微信SDK支付','8':'微信公众号支付','9':'支付宝服务窗支付','10':'微信扫码','11':'支付宝扫码']
    def static serviceTypeMap=[ 'onlinePay':'在线支付','quickPay':'快捷支付','royalty':'分润', 'agentCol': '代收','agentPay':'代付', 'mobilePay':'手机支付', 'personPortal':'个人门户','virtualAcc':'虚拟账户', 'settle':'清结算系统', 'offlinepay':'线下充值']
}
