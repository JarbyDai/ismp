<div class="topmenu">
    	<div class="topbox">
        	<div class="logo"></div>
        	<div class="topuser">欢迎，${session.cmCustomerOperator.name} [<a href="${createLink(controller:'login',action:'logout')}" class=" blue">退出</a>] | <a href="http://www.helipay.com/index.html" target="_blank" class=" blue">合利宝首页</a></div>
    	</div>
        <div class="grxx_menu">
        <!-- 导航 -->
           <div id="nav">
