    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <g:each in="${tradeList}" status="i" var="trade">
            <tr height=18 style='height:13.5pt'>
                ...
                <td class=xl657821 style='border-left:none'>${trade.tradeAccountname},${trade.tradeBranchbank!='null'?trade.tradeBranchbank:''},${trade.tradeSubbranchbank!='null'?trade.tradeSubbranchbank:''}</td>
