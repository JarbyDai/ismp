...
<div class="trnmenu">
  ...
  <div class="rtnms">
    <ul>
      <li class="rtncnt blue">代付审核</li>
    </ul>
  </div>
</div>
<form action="agentpaylist" method="post" name="searchform" id="searchform" style="width:960px; margin:0 auto">
    <g:if test="${flash.message}">
        <div class="message"><font color="red">${flash.message}</font></div>
    </g:if>
    <div id="agentpayMsg">
        <g:if test="${errmsg}">
            <div id="agentpaytMsg" class="serch"><P>${errmsg.encodeAsHTML()}</P></div>
        </g:if>
    </div>
    <div class="serch">
      <p>搜索</p>
          ...
          <tr>
            ...
            <g:each in="${tradeList}" status="i" var="trade">
                <tr>
                    ...
                    <td class="txtCenter" scope="col"><strong style="color:purple;"><g:formatNumber currencyCode="CNY" number="${trade.batchFee}" type="currency"/></strong></td>
                    <td class="txtCenter" scope="col">${trade.feeTypeMap[trade.batchFeetype]}</td>
                    <td class="txtCenter" scope="col"><strong style="color:red"><g:formatNumber currencyCode="CNY" number="${trade.batchAccamount}" type="currency"/></strong></td>
                    ...
                    <td class="txtCenter" scope="col">
                        <g:if test="${session.level3Map != null && session.level3Map['tbAgentpayInfo/verify'] != null}">
                          <a href="${request.contextPath}/${session.level3Map['tbAgentpayInfo/verify'].modelPath}/${trade.id}" style="color:blue;">审核</a>
                        </g:if>
