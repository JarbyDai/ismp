...
<div class="trnmenu">
  ...
  <div class="rtnms">
    <ul>
      <li class="rtncnt blue">代收审核</li>
    </ul>
  </div>
</div>
<form action="agentdeductlist" method="post" name="searchform" id="searchform" style="width:960px; margin:0 auto">
    <div class="serch">
      <p>搜索</p>
