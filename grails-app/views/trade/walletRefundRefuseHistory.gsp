<%@ page import="ismp.UserOrder; ismp.TradePayment; ismp.TradeBase" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="layout" content="main"/>
    <title>合利宝-钱包退款审核拒绝交易</title>
...
<div class="trnmenu"> <span class="left trnmenutlt">钱包交易管理：</span>
  <div class="rtnms">
    <ul>
        <g:if test="${session.level3Map != null && session.level3Map['trade/walletRefund'] != null}">
            <li>
            <a href="${request.contextPath}/${session.level3Map['trade/walletRefund'].modelPath}">钱包退款审核</a>
            </li>
        </g:if>
        <li class="rtncnt blue">退款拒绝记录</li>
    </ul>
  </div>
</div>
<form action="walletRefundRefuseHistory" method="post" name="searchform" id="searchform" style="width:960px; margin:0 auto">
    <div class="serch">
        <p>搜索</p>
