...
9752;width:65pt'>
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  width:151pt'>合利宝退款交易查询<span style='mso-spacerun:yes'>&nbsp;</span></td>
 ...
 <tr class=xl637821 height=18 style='height:13.5pt'>
  ...
  <td class=xl667821 style='border-left:none'>退款订单号</td>
  %{--<td class=xl667821 style='border-left:none'>原交易号</td>--}%
  <td class=xl667821 style='border-left:none'>原订单号</td>
...
<g:each in="${tradeList}" status="i" var="trade">
 <tr height=18 style='height:13.5pt'>
  ...
  %{--<td class=xl677821  align=right style='border-left:none'><%=AccountCommandPackage.getOrgTransno(trade.originalId)%></td>--}%
  <td  class=xl677821 style='border-left:none'>${TradeBase.findByRootIdAndTradeType(trade.rootId,'payment')?.outTradeNo}</td>
  <td  class=xl677821 style='border-left:none'>${TradeBase.findByRootIdAndTradeType(trade.rootId,'charge')?.outTradeNo}</td>

  <td class=xl677821 style='border-left:none'>${trade.tradeNo}</td>
  <td class=xl657821  align=right style='border-left:none'>${trade.payerName=='访客公用账户'?'':trade.payerName}</td>
  <td class=xl657821  align=right style='border-left:none'><strong class="hsfong"><g:formatNumber currencyCode="CNY" number="${trade.feeAmount/100}" type="currency"/></strong></td>
  <td class=xl657821  align=right style='border-left:none'><strong class="hsfong"><g:formatNumber currencyCode="CNY" number="${trade.amount/100}" type="currency"/></strong></td>
