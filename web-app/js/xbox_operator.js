...
new AP.widget.Validator(
{
	...
	userDefine:function(a)
	{
		...
		return false
			...
			'newloginpass':{required:true,depends:false,desc:"新的登录密码"},
			'confirm_newloginpass':{required:true,depends:false,desc:"确认登录密码"}
	}
});
...
new AP.widget.Validator(
{
	...
	userDefine:function(a)
	{
		...
		return false
			...
			'newpaypass':{required:true,depends:false,desc:"新的支付密码"},
			'confirm_newpaypass':{required:true,depends:false,desc:"确认支付密码"}
	}
});
